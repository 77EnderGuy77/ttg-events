  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-2 text-[12px] text-ink-4 mb-5">
        <Link to="/internal/stores" className="hover:text-ink-2 transition-colors">Stores</Link>
        <span>/</span>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          {store.website && <a href={store.website} className="text-[12px] text-purple hover:underline">{store.website}</a>}
        </div>
      </div>
