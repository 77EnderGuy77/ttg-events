      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/internal/applications" className="text-[12px] text-purple hover:underline">View all →</Link>
          </div>
          {pending.length === 0 ? (
            ...
            <div className="flex flex-col gap-2">
              {pending.slice(0, 3).map(app => (
                <Link key={app.id} to="/internal/applications">
              ...
              {pending.length > 3 && (
                <Link to="/internal/applications" className="text-[12px] text-ink-4 hover:text-ink text-center py-1">
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/internal/stores" className="text-[12px] text-purple hover:underline">All stores →</Link>
          </div>
          <div className="flex flex-col gap-2">
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/internal/events" className="text-[12px] text-purple hover:underline">All events →</Link>
          </div>
          <div className="flex flex-col gap-2">
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/internal/subscriptions" className="text-[12px] text-purple hover:underline">Details →</Link>
          </div>
          <div className="bg-surface-2 border border-line rounded-[10px] p-4">
