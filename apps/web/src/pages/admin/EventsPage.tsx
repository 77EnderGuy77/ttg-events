                ...
                return (
                  <TableRow key={ev.id}>
                    ...
                    <TableCell>
                      {(() => {
                        const s = ev.status
                        const cls = s === 'active' ? 'text-green bg-green/10 border-green/20'
                          : s === 'upcoming' ? 'text-blue bg-blue/10 border-blue/20'
                          : s === 'cancelled' ? 'text-red bg-red/10 border-red/20'
                          : 'text-ink-3 bg-surface-3 border-line'
                        return (
                          <span className={`text-[10px] border rounded-[4px] px-[7px] py-[2px] capitalize ${cls}`}>
                            {s}
                          </span>
                        )
                      })()}
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Link to="/admin/events/$eventId" params={{ eventId: ev.id }}>
