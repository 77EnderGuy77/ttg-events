          ...
          <tbody>
            {rows.map(row => (
              <tr key={row.id} className="hover:bg-surface-3 transition-colors">
                ...
                <td className="px-[14px] py-[8px] border-b border-line-soft text-[11px] text-ink-3 max-w-[140px] truncate">{row.actor}</td>
                <td className="px-[14px] py-[8px] border-b border-line-soft text-[11px] text-ink-3 max-w-[160px] truncate">{row.target}</td>
                <td className="px-[14px] py-[8px] border-b border-line-soft">
                ...
                <td className="px-[14px] py-[8px] border-b border-line-soft text-[11px] text-ink-3">{formatTime(row.at)}</td>
              </tr>
            ))}
          </tbody>
        </table>
