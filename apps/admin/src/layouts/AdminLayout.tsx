...
const NAV_ITEMS = [
  { key: 'dashboard',       to: '/',               label: 'Dashboard',       superOnly: false, icon: 'M4 5h16v4H4zm0 6h7v9H4zm9 0h7v4h-7zm0 6h7v3h-7' },
  { key: 'events',          to: '/events',          label: 'Events',          superOnly: false, icon: 'M8 2v3M16 2v3M3 8h18M5 4h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z' },
  { key: 'stores',          to: '/stores',          label: 'Stores',          superOnly: true,  icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z' },
  { key: 'store-requests',  to: '/store-requests',  label: 'Store Requests',  superOnly: true,  badge: 2, icon: 'M4 4h16v2H4zM4 9h16v2H4zM4 14h10v2H4z' },
  { key: 'subscriptions',   to: '/subscriptions',   label: 'Subscriptions',   superOnly: true,  icon: 'M20 7H4a2 2 0 00-2 2v6a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zM12 13a2 2 0 110-4 2 2 0 010 4z' },
  { key: 'notifications',   to: '/notifications',   label: 'Notifications',   superOnly: true,  icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
  { key: 'audit-log',       to: '/audit-log',       label: 'Audit Log',       superOnly: true,  icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
  { key: 'settings',        to: '/settings',        label: 'Settings',        superOnly: true,  icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0' },
]

const PAGE_TITLES: Record<string, string> = {
  '/': 'Dashboard', '/events': 'Events', '/stores': 'Stores',
  '/store-requests': 'Store Requests', '/subscriptions': 'Subscriptions',
  '/notifications': 'Notifications', '/audit-log': 'Audit Log',
  '/settings': 'Settings', '/revenue': 'Revenue', '/subscription': 'Subscription',
}
  ...
  return (
    <div className="flex min-h-dvh bg-surface">
      <aside className="w-[220px] shrink-0 bg-surface-2 border-r border-line flex flex-col">
        ...
        {/* Footer */}
        <div className="px-4 py-[10px] border-t border-line flex items-center gap-2">
