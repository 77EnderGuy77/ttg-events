        ...
        {(['all', 'free', 'basic', 'pro'] as const).map(t => (
          <button
            ...
            className={`text-[11px] px-3 py-1.5 rounded-[6px] border capitalize transition-colors ${
              tierFilter === t ? 'bg-purple/10 text-purple-light border-purple/30' : 'bg-surface-2 text-ink-3 border-line hover:text-ink'
            }`}
          >
            {t === 'all' ? 'All tiers' : t}
          </button>
                  ...
                  <tr key={store.id} className="border-t border-line hover:bg-surface-3 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <Link
                        ...
                        className="text-[11px] text-purple-light hover:underline"
                      >
                        View →
                      </Link>
                    </td>
